...
export default function CategoryManage() {
  ...
  const isFromAddBill = (location.state as { fromAddBill?: boolean })?.fromAddBill === true;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <Modal
        isOpen={showAddModal}
        onClose={() => { setShowAddModal(false); setNewName(''); setNewIcon('Circle'); }}
        title="添加新分类"
        showFooter
        confirmText="添加"
