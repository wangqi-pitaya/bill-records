...
const isBetween = (date: string, start: string, end: string): boolean => {
...
export function YearMonthPicker({ isOpen, value, onConfirm, onClose, mode = 'month', themeColor = '#10b981' }: YearMonthPickerProps) {
