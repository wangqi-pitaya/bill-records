      ...
      {toasts.map((toast) => {
        ...
        return (
          <div
            key={toast.id}
            className={cn(
              'pointer-events-none flex items-center gap-2 px-3 py-2 rounded-lg bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm shadow-sm animate-toast-in transition-all duration-300',
            )}
          >
